    ...
    <body>
        ...
        <div class="wrap">
            ...
            <!-- -------------------------- -->
                    ...
                    <c:forEach var="dto" items="${list}">
                          ...
                          &nbsp;&nbsp;&nbsp;&nbsp;
                           <c:if test="${dto.fileName != null}">
                                 <img src="/images/attach.PNG" style="width:1.2em">
                           </c:if>
                          </li>
                          <li>${dto.name}</li>
                          <li>

                            <fmt:formatDate value="${dto.wdate}" pattern="yy-MM-dd"/>
             ...
             <div class="pageNavi text-center mt-4">
                <!-- 페이지 네비 (페이징 블럭 처리 안할 경우)-->
                <c:forEach var="i" begin="1" end="${page.pageCount}" step="1">
                    [<a href="/posts/list?pageNum=${i}">${i}</a>]
                </c:forEach>
