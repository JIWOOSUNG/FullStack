...
let st1 = new Student(1, '홍길동', 94, 88); // 생성자 함수를 호출할 때는 new 연산자와 같이 사용한다
console.log(st1.name); //name => 인스턴스(객체) 변수

//학생 객체 2개 생성해보기
let st2 = new Student(2, '김철수', 100,100);
// let st3 = Student(3, '김미영', 50,50); [권하지 않음] 에러발생
console.log(st2.name)

//st1의 각 메서드 호출하기
let info = st1.toString();
console.log(info);
console.log(`합계점수: ${st1.getSum()}`);
console.log(`평균점수: ${st1.getAvg()}`);
