            ...
            <form action="/input" method="post" onSubmit={onSubmit}>
                ...
                <div className="row my-4">
                    <div className="col-md-8 offset-md-2">
                        ...
                        <button className="btn btn-outline-success" type="button" onClick={onCheckEmail}>
                            중복체크
                        </button>
                ...
                <div className="row my-4">
                    <div className="col-md-8 offset-md-2">
                        <label>
                            <input type="checkbox" name="agree" id="agree" onChange={onChangeAgree} />
                            이용약관에 동의합니다.
                        </label>
                ...
                <div className="row">
                    <div className="col-md-8 offset-md-2 text-center">
                        ...
                        <button type="reset" onClick={onReset} className="btn btn-outline-danger">
                            다시쓰기
                        </button>
                    </div>
                </div>
