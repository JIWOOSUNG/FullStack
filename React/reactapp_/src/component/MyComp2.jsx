...
const MyComp2 = () => {
    ...
    return (
        <div className="comp2 comp">
            ...
            <p style={{ background: 'blue', color: 'white', padding: 8 }}>
                토클 버튼을 클릭해보세요. LifeCycle컴포넌트가 mount/unmount됩니다. show: {show}{' '}
            </p>
            <button onClick={toggleComponent} className="btn btn-success">
                컴포넌트 토글 {show}{' '}
            </button>
