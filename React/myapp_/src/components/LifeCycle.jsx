...
//2. 토글 버튼으로 컴포넌트 제거: 컴포넌트가 언마운트되고 새로운 렌더링이 발생합니다.
// 이 때 먼저 componentWillUnmount가 호출되어 컴포넌트가 제거되기 전에 필요한 정리 작업을 수행
...
export default class LifeCycle extends Component {
    ...
    render() {
        ...
        return (
            <div className="container py-4" style={{ height: '300px', border: '1px solid silver' }}>
                <h1>자식 컴포넌트 LifeCycle</h1>
            </div>
        );
    }
}
